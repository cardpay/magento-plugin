...
class Api
{
    ...
    public function __construct()
    {
        ...
        if ($numberOfArguments > 2 || $numberOfArguments < 1) {
            throw new UnlimitBaseException('Invalid arguments. Use CLIENT_ID and CLIENT SECRET, or ACCESS_TOKEN');
        }
    ...
    public function getAccessToken()
    {
        ...
        if ((int)$authResponse['status'] !== 200) {
            ...
            throw new UnlimitBaseException($message, $authResponse['status']);
        }
    ...
    public function get($uri, $params = null, $authenticate = true)
    {
        ...
        $uri = $this->buildUriWithParams($uri, $params);
    ...
    function buildUriWithParams($uri, $params)
    {
        ...
        if (count($params) > 0) {
            ...
            $uri .= $separator.$this->buildQuery($params);
        }
    ...
    public function post($uri, $data, $urlParams = null)
    {
        ...
        $extraParams = [self::AUTH_HEADER_PREFIX.$this->getAccessToken()];
    ...
    public function put($uri, $data, $params = null)
    {
        return RestClient::put(
            ...
            $data,
            [self::AUTH_HEADER_PREFIX.$this->getAccessToken()]
        );
    }
