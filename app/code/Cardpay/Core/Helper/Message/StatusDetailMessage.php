...
class StatusDetailMessage extends AbstractMessage
{
    ...
    protected $messagesMap = [
        ...
        "cc_rejected_duplicated_payment" => 'You already made a payment by that value.<br/>'.
            'If you need to repay, use another card or other payment method.',
        "cc_rejected_high_risk" => 'Your payment was rejected.<br/>'.
            'Choose another payment method, we recommend cash methods.',
        ...
        "cc_rejected_max_attempts" => 'You have got to the limit of allowed attempts.<br/>'.
