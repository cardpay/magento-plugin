...
class Response
{
    ...
    const HTTP_UNAUTHORIZED = 500; // changed the status because the Unlimint only renotify when it is 500 - old status:401;
    const HTTP_FORBIDDEN = 500; // changed the status because the Unlimint only renotify when it is 500 - old status:403;
    const HTTP_NOT_FOUND = 500; // changed the status because the Unlimint only renotify when it is 500 - old status:404;
    const HTTP_METHOD_NOT_ALLOWED = 500; // changed the status because the Unlimint only renotify when it is 500 - old status:405;
    const HTTP_NOT_ACCEPTABLE = 500; // changed the status because the Unlimint only renotify when it is 500 - old status:406;
