    ...
    function (Component, quote, paymentService, paymentMethodList, getTotalsAction, $, fullScreenLoader, setAnalyticsInformation, $t, defaultTotal, cartCache) {
        ...
        return Component.extend({
            ...
            getData: function () {
                return {
                    ...
                    'additional_data': {
                        ...
                        'cpf': document.getElementById('cpf_pix') ? document.querySelector(CPv1Pix.selectors.cpfPix).value : null
                    }
                };
            },
            ...
            validateCpfPix: function (a, b) {
                var self = this;
                var cpfPix = document.querySelector(CPv1Pix.selectors.cpfPix).value;
            ...
            showError: function (code) {
                var $form = document.querySelector(CPv1Pix.selectors.formPix);
