...
namespace Cardpay\Core\Model\Api\V1;

use Magento\Framework\Phrase;

/**
 *  Exception which thrown by Unlimint API in case of processable error codes from api v1
 *
 * Class Exception
 *
 * @package Cardpay\Core\Model\Api\V1
 */
class Exception extends \Cardpay\Core\Model\Api\Exception
{
    /**
     *  map messages
     *
