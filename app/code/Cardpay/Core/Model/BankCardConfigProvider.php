...
class BankCardConfigProvider extends BasicConfigProvider
{
    ...
    public function getConfig()
    {
        ...
        return [
            'payment' => [
                $this->methodCode => [
                    'maximum_accepted_installments' => $this->getConfigWithDefault(
                    ...
                    'installment_type' => $this->getConfigWithDefault(
                        ConfigData::PATH_BANKCARD_INSTALLMENT_TYPE,
                        $scope
                    ),
                    'minimum_installment_amount' => $this->getConfigWithDefault(
                    ...
                    'are_installments_enabled' => $this->getConfigWithDefault(
