...
class PaymentStatusHandler
{
    ...
    public function changePaymentStatus($observer, $statusTo, $expectedResponseStatus)
    {
        ...
        $this->createTransactionForInvoice($observer, $paymentResponse[$apiStructure], $payment['additional_information']['installments']);
     ...
     */
    private function createTransactionForInvoice($observer, $paymentData, $numInstallments)
    {
